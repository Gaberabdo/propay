                            ...
                            title: Column(
                              ...
                              children: [
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        mainAxisSize:
                                                                            MainAxisSize.min,
                                                                        children: [
                                                                          supportTicketCtrl.attachmentPath == e.attachmentPath && supportTicketCtrl.isDownloadPressed
                                                                              ? Text(
                                ...
                                Visibility(
                                    ...
                                    child: Text(
                                      selectedIndex == index
                                          ? '${changeDateFormat(data.createdAt)}'
                                          : '',
                          ...
                          onTap: () async {
                            if (supportTicketCtrl
                              ...
                              supportTicketCtrl
                                  .replyTicket(
                                      context: context,
                                      id: supportTicketCtrl.viewTicketList[0].id
                                          .toString())
                                  .then((value) =>
                                      supportTicketCtrl.getTicketView(
                                          ticketId: widget.ticketId!,isFromCreatingTicket: true));
                              supportTicketCtrl.update();
                            }
                          },
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Image.asset(
                                  supportTicketCtrl.replyEditingCtrlEmpty
                                      ...
                                      : "$rootImageDir/send_active.png", color: supportTicketCtrl.replyEditingCtrlEmpty
                                      ? AppColors.black20
                                      : AppColors.mainColor),
                            ),
                          ),
              ...
              return <PopupMenuEntry<String>>[
                ...
                if (supportTicketCtrl.isViewingTicket == false)
                  if (supportTicketCtrl.viewTicketList.isNotEmpty)
                    if (supportTicketCtrl.viewTicketList[0].status !=
                        "Closed")
                      PopupMenuItem<String>(
                        value: "Close Ticket",
                        child: GestureDetector(
                          onTap: () {
                            ...
                            openDialg(
                                supportTicketCtrl,
                                supportTicketCtrl.viewTicketList[0].id
                                    .toString());
                          },
                          child: Text(
                  ...
                  child: AppButton(
                    ...
                    onTap: () async {
                      supportTicketController
                          .replyTicket(
                              context: context, id: id, isCloseTicket: true)
                          .then((value) {
                        supportTicketController.resetDataAfterSearching();
                        supportTicketController.getTicketList(page: 1);
                      });
                      Get.back();
                    },
                  ),
